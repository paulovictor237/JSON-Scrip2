...
//+------------------------------------------------------------<<
  ...
  _mkdir("file_out/relatorio");
  _mkdir("file_out/simulacao");
//+------------------------------------------------------------<< 
  std::cout << "$ >> OPCOES << $\n"<< endl;
...
//+------------------------------------------------------------<< 
  //abre os arquivos
  std::ofstream simulacao_src("file_out/simulacao/simulacao.src",std::ofstream::out);
  std::ofstream simulacao_dat("file_out/simulacao/simulacao.dat",std::ofstream::out);
...
//+------------------------------------------------------------<< 
  std::cout << "$ >> RECEITA CRIADA << $\n"<<endl;
  std::cout << "Relatorio gerado em [ file_out/relatorio/Relatorio.md ]"<<endl;
  std::cout << "\n-----------------------------\n" << endl;
  //std::cout << "Pressione qualquer tecla para fechar esta janela" << endl;
  std::system("pause");
  //std::system("pause");std::cin.get();
  //std::system("pause");//;cin>>system_in;
  std::ofstream Relatorio("file_out/relatorio/Relatorio.md");
